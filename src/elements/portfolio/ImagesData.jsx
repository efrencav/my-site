...
const PortfolioListContent = [
    ...
    // Schlumberger Identity Guidelines and Graphic Standards Website
    {
        ...
        phaseOneDesc: [
            `This web design project was developed to include all existing collateral from the new identity guidelines and graphic standards and inform users of the proper branding use and allow a version control for the identity guidelines.`
        ],
        phaseOneDescMore: [
            ``,
        ],
        ...
        phaseThreeDesc: [
            `The new visual identity site is still under development and scheduled to launch at the end of 2020. The flexibility of the online use of the style guide will allow users to be more compliant and communicate appropriately with their stakeholders.`,
        ],
        phaseThreeDescMore: [
            ``
        ],
